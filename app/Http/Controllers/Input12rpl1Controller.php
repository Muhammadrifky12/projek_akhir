...
use App\Models\input12rpl1;
use App\Models\Pelanggaran;
use App\Models\Siswa12;
use Illuminate\Support\Facades\Session;
use Illuminate\Http\Request;

class Input12rpl1Controller extends Controller
{
    /**
    ...
    {
        $skor = input12rpl1::all();
        $pela = Pelanggaran::all();
        $siswa = Siswa12::all();
        $dataa = input12rpl1::paginate(15);
        return view('Input.Input12rpl1' ,compact('skor','pela','siswa','dataa'));
    }
    ...
    {
        $siswaku = input12rpl1::find($id);
        $pela = Pelanggaran::all();
        return view('edit.Einput12rpl1' ,compact('siswaku','pela'));
    }
