            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row">{{ ++$g }}</th>
                        <td>{{ $hallo-> id_nama }}</td>
                        <td><a href="{{ route('Gurutatib.hapus', $hallo ->id_nama) }}" class="btn-sm btn-circle"><i
                                    class="fas fa-trash"></i></a>
                            <a href="" class="btn-sm btn-circle"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
...
<!-- Modal guru tatib-->
<div class="modal fade" id="tatib" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Guru BK</h5>
