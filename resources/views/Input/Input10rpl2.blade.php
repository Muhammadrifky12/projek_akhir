                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="" class="btn-sm btn-circle"><i class="fas fa-trash"></i></a>
                                <a href="{{ route('Input11rpl1.edit', $items->id) }}" class="btn-sm btn-circle"><i
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('Input10rpl2.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('Input10rpl2.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
