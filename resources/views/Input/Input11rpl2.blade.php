                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="" class="btn-sm btn-circle"><i class="fas fa-trash"></i></a>
                                <a href="{{ route('Input11rpl2.edit', $items->id) }}" class="btn-sm btn-circle"><i
...
<div class="modal fade" id="tamm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('Input11rpl2.store') }}">
                    @csrf
