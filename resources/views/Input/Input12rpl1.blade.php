...
<div class="row">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-1">
                <a href="" class="btn-lg btn-circle btn-danger" data-toggle="tooltip" data-placement="top"
        ...
        <div class="card shadow">
            <div class="card-header" id="p">
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#halo">
                            Tambah
                        </button>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="" class="btn-sm btn-circle"><i class="fas fa-trash"></i></a>
                                <a href="{{ route('Input12rpl1.edit', $items->id) }}" class="btn-sm btn-circle"><i
...
<div class="modal fade" id="halo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('Input12rpl1.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('Input12rpl1.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
