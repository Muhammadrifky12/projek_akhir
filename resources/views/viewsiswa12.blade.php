...
@section('content-title', 'Kelas 12 RPL 1')
@section('content')
    <style>
        #p {
                        ...
                        <div class="card shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <img src="{{ asset('./template/img/bupin.jpg') }}" width="150"
                                            alt="Dra.Retno Pinasti">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <a class="btn btn-secondary dropdown-toggle" href="#" role="button"
                                        id="k" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Kelas 10 RPL
                                    </a>
                                ...
                                <div class="col-lg-2">
                                    <a href="{{ route('viewsiswa12.create') }}" type="button" class="btn btn-success"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data6 as $b => $items)
                                                    <tr>
                                                        ...
                                                        <td>{{ $items->JK }}</td>
                                                        <td><a href="{{ route('viewsiswa12.hapus', $items->nama) }}"
                                                                class="btn-sm btn-circle"><i
